...
public class PlayerControllerX : MonoBehaviour
{
    ...
    private float yRangeTop = 15.0f;
    private float yRangeBot = 2.0f;
    ...
    void Update()
    {
        ...
        if (transform.position.y < yRangeBot && !gameOver)
        {
            playerRb.AddForce(Vector3.up * 5, ForceMode.Impulse);
            playerAudio.PlayOneShot(hitGroundSound, 1.0f);
            //transform.position = new Vector3(transform.position.x, yRangeBot, transform.position.z);
        }
    }
